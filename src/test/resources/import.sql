...
insert into users (id, username, password, first_name, last_name, role, expired_date, active, email, reset_password_flag) values (1, 'user1', '6964f527f011df8756f87c3e8a76884f','fistname1', 'lastname1', 'ADMINISTRATOR', '2020-01-01', 1, 'emai1@abc', 0);
insert into users (id, username, password, first_name, last_name, role, expired_date, active, email, reset_password_flag) values (2, 'user2', '6964f527f011df8756f87c3e8a76884f','fistname2', 'lastname2', 'DESIGNER', '2020-01-01', 1, 'emai2@abc', 0);
insert into users (id, username, password, first_name, last_name, role, expired_date, active, email, reset_password_flag) values (3, 'user3', '6964f527f011df8756f87c3e8a76884f','fistname3', 'lastname3', 'EDITOR', '2020-01-01', 1, 'chaukynguyen@gmail.com', 0);
